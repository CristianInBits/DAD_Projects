package es.chatgpt.code.ejemplo21_db.controllers;
...
import es.chatgpt.code.ejemplo21_db.service.CommentService;
import es.chatgpt.code.ejemplo21_db.service.PostService;
...
public class PostController {
    ...
    public List<Post> getPosts(@RequestParam(required = false) String commentsUser) {
        if (commentsUser == null) {
            ...
            return posts.findByCommentUser(commentsUser);
        }
    }
    ...
    @DeleteMapping("{idPost}/comments/{idComments}")
